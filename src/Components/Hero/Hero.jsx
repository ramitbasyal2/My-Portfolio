     ...
     <div className="max-w-7xl mx-auto flex items-center justify-center flex-col text-center px-6 md:px-12 lg:px-24 max-sm:py-20 py-30">
      ...
      <div className="mt-17 max-sm:text-5xl sm:text-8xl md:text-[110px] lg:text-[130px] font-bold">
        ...
        <h1><span className="relative text-gray-600">B
           <span className="absolute inset-0 top-2.5 lg:top-7 right-6 text-gray-100 font-medium">B</span>
        </span>
             <span className="relative text-gray-600">U
           <span className="absolute inset-0 top-2.5 lg:top-7 right-6 text-gray-100 font-medium">U</span>
        </span>
        <span className="relative text-gray-600">I
           <span className="absolute inset-0 top-2.5 lg:top-7 right-6 text-gray-100 font-medium">I</span>
        </span>
        <span className="relative text-gray-600">L
           <span className="absolute inset-0 top-2.5 lg:top-7 right-6 text-gray-100 font-medium">L</span>
        </span>
        <span className="relative text-gray-600">T
           <span className="absolute inset-0 top-2.5 lg:top-7 right-6 text-gray-100 font-medium">T</span>
        </span>
             
             </h1>
       <div className="flex gap-4">
         <h1 className="text-blue-800"><span className="relative text-gray-600">T
           <span className="absolute inset-0 top-2.5 lg:top-7 right-6 text-gray-300 font-medium">T</span>
        </span>
        <span className="relative text-gray-600">O
           <span className="absolute inset-0 top-2.5 lg:top-7 right-6 text-gray-300 font-medium">O</span>
        </span>
        </h1>
         <h1><span className="relative text-gray-600">B
           <span className="absolute inset-0 top-2.5 lg:top-7 right-6 text-gray-400 font-medium">B</span>
        </span>
             <span className="relative text-gray-600">U
           <span className="absolute inset-0 top-2.5 lg:top-7 right-6 text-gray-400 font-medium">U</span>
        </span>
        <span className="relative text-gray-600">I
           <span className="absolute inset-0 top-2.5 lg:top-7 right-6 text-gray-400 font-medium">I</span>
        </span>
        <span className="relative text-gray-600">L
           <span className="absolute inset-0 top-2.5 lg:top-7 right-6 text-gray-400 font-medium">L</span>
        </span>
        <span className="relative text-gray-600">D
           <span className="absolute inset-0 top-2.5 lg:top-7 right-6 text-gray-400 font-medium">D</span>
        </span>
