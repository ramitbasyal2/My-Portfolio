      ...
      <div className=" max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 max-sm:gap-2 gap-20">
        <div>
          ...
          <motion.div
            ...
            className="relative w-full border border-gray-400 rounded-2xl max-w-[600px] h-[450px] md:h-[600px]
             lg:h-[650px] mx-auto max-sm:mb-48 flex items-center justify-center flex-col space-y-4 " >
              
              <div className=' relative w-[280px] h-[270px] lg:w-[330px] lg:h-[360px] rounded-3xl bg-gray-800 group-hover:rotate-90 '>
                <div className='absolute group w-[270px] h-[280px]  lg:w-[320px] lg:h-[330px] top-8 -right-5 rounded-3xl'>
                    <img className='w-full h-full object-cover rounded-3xl' src="./profile1.jpeg" alt="" /></div>
              </div>
                <h1 className='text-white  font-bold text-3xl font-[cursive] mt-6'>Ramit Basyal</h1>
             ...
             {/* tag */}
            <div className=" absolute -right-5 -bottom-15 bg-blue-800 max-sm:p-2  p-4 max-sm:text-[18px] text-2xl font-bold text-white rounded-xl
             max-sm:w-[190px] max-sm:h-[90px] w-[260px] h-[110px]" >
