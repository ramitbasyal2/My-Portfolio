...
>
     {  <div onClick={()=> setIsMenuOpen(false)} 
        ...
        <button className='lg:hidden max-sm:hidden  md:px-6 md:py-3 px-4 py-2 mt-4 bg-white text-[16px] font-medium text-black rounded-[50px] hover:bg-[#d1d1d1a5] cursor-pointer' onClick={()=> {setState(true);setIsMenuOpen(false); }}>Hire Me</button>          
       </ul>
